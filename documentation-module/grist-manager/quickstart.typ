// Grist Manager Quickstart Guide

#import "../common/styles.typ": *
#import "../common/grist-fundamentals.typ": grist_connection_config
...
#info_box(type: "info")[
  *New to Grist?* You can create a free account at https://docs.getgrist.com. For production use, consider self-hosting Grist (see the DevOps documentation).
]
...
#info_box(type: "warning")[
  *Document ID is sensitive!* Anyone with your document ID and API key can access your data. Keep both secure and never commit them to version control.
]
...
#table(
  ...
  [Text],
  [✓],
  [This will be the unique identifier for login],
...
#table(
  ...
  [`full_name`],
  [Text],
  [User's display name for the UI],
...
#info_box(type: "danger")[
  *Security Warning*: Never use "password123" or simple passwords in production! This is a test example only. In production, passwords should be strong and hashed by your application using bcrypt or Argon2.
]
...
#info_box(type: "success")[
  *Success!* If all three tests return valid JSON responses, your Grist document is properly configured for FlutterGristAPI.
]
...
#info_box(type: "info")[
  *Access Rules are advanced*: For initial development, you can skip this step. Revisit it before deploying to production.
]
...
#info_box(type: "success")[
  *You're ready!* You've successfully set up your first Grist document for FlutterGristAPI. The rest of this documentation will help you master advanced database management techniques.
]
