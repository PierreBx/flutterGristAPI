...
#table(
  ...
  [*App Designer*],
  [
    - Available data fields for UI
    - Data constraints and validation rules
    - User roles and permissions structure
  ],
  [
    - UI mockups showing data needs
...
#info_box(type: "info")[
  *Access*: Navigate to your Grist instance (e.g., https://docs.getgrist.com or your self-hosted URL) and log in to access the web interface.
]
...
#info_box(type: "success")[
  *You're in the right place!* This documentation is specifically designed for Grist Managers. Each section builds on the previous one, taking you from basics to advanced database administration for FlutterGristAPI.
]
