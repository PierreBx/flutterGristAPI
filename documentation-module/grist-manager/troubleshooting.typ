// Troubleshooting Guide for Grist Managers
...
#info_box(type: "warning")[
  *Security*: Never share API keys in error reports or public forums. Regenerate if accidentally exposed.
]
...
#info_box(type: "info")[
  *Pro Tip*: Before posting questions, search existing issues and forum posts. Many common problems have already been solved!
]
...
#info_box(type: "success")[
  *Prevention is better than cure*: Many issues can be avoided with proper planning, testing, and documentation.
]
