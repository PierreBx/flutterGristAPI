// Command Reference - FlutterGristAPI
// Comprehensive reference for Docker and DevOps commands
...
#command_table((
  (
    ...
    description: "Start Grist server",
    example: ""
  ),
  (
...
#command_table((
  (
    ...
    description: "Emergency Grist restart",
    example: ""
  ),
  (
