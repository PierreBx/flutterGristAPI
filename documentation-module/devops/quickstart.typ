// DevOps Quick Start - FlutterGristAPI
// First-time setup guide for Docker environment
...
#info_box(type: "info")[
  **All commands must be run from the project root directory** unless otherwise specified.
]
...
#info_box(type: "success")[
  **Congratulations!** Your FlutterGristAPI environment is ready.
