// Docker Setup and Configuration - FlutterGristAPI
// Comprehensive guide to Docker infrastructure
...
#command_table((
  (
    ...
    description: "Start Grist server in detached mode",
    example: "docker-compose up -d grist"
  ),
  (
...
#info_box(type: "info")[
  For more troubleshooting guidance, see `troubleshooting.typ`
]
