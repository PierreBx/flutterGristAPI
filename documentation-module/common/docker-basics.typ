// Docker fundamentals for FlutterGristAPI

#import "styles.typ": *

#let docker_fundamentals() = [
  == Docker Basics
  ...
  #troubleshooting_table((
    (
      ...
      solution: "Check logs with `docker logs container_name`. Verify port availability and environment variables.",
      priority: "high"
    ),
    (
