#set document(title: "flutter_grist_widgets Documentation", author: "flutter_grist_widgets contributors")
#set page(paper: "a4", margin: (x: 2.5cm, y: 2.5cm))
#set text(font: "Linux Libertine", size: 11pt)
#set heading(numbering: "1.1")

#align(center)[
  #text(size: 24pt, weight: "bold")[flutter_grist_widgets]

  #v(1em)

  #text(size: 14pt)[A YAML-Driven Flutter Application Generator for Grist]
