...
#doc_header(
  ...
  subtitle: "Daily Development Practices for Flutter Developers",
  version: "0.3.0"
)
...
#info_box(type: "info")[
  Follow the existing code style. The project uses `flutter format` for consistent formatting.
]
...
#info_box(type: "warning")[
  Always test after updating dependencies. Breaking changes in dependencies can cause issues.
]
...
#info_box(type: "warning")[
  Only force push to your own feature branches, never to main or shared branches.
]
...
///
/// Returns `null` if [value] is a valid email, otherwise returns
...
#info_box(type: "success")[
  Following this workflow will help you be productive and maintain high code quality in the FlutterGristAPI project.
]
