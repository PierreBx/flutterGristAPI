...
#doc_header(
  ...
  subtitle: "FlutterGristAPI Library Development",
  version: "0.3.0"
)
...
#info_box(type: "info")[
  See `development-workflow.typ` for detailed daily workflow, testing procedures, and Git workflow.
]
...
///
/// Returns a list of records as maps with 'id' and 'fields' keys.
...
#info_box(type: "success")[
  Welcome to the FlutterGristAPI development team! We're excited to have you contribute to making this library better.
]
