...
#doc_header(
  "Command Reference",
  subtitle: "Essential Commands for Flutter Development",
  version: "0.3.0"
)
...
#command_table((
  (
    command: "./docker-test.sh grist-start",
    description: "Start Grist server on port 8484",
    example: "./docker-test.sh grist-start"
  ),
  (
...
#command_table((
  (
    ...
    description: "Download dependencies from pubspec.yaml",
...
#command_table((
  (
    ...
    example: "flutter format lib/ test/"
  ),
  (
...
#command_table((
  (
    ...
    description: "Delete build artifacts and caches",
...
#command_table((
  (
    ...
    example: "git restore lib/src/utils/validators.dart"
  ),
  (
...
#command_table((
  (
    ...
    description: "Create pull request interactively",
...
#info_box(type: "info")[
  Bookmark this page for quick reference to all commands you'll need during development!
]
