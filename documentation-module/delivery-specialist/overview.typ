// Overview - Delivery Specialist Role
...
#info_box(type: "info")[
  *Getting Started*: New to the Delivery Specialist role? Begin with the Quickstart guide in the next section to set up your CI/CD environment in under 30 minutes.
]
