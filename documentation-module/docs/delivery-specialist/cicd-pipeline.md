...
> **Warning**: *Security Critical*: This job will fail the pipeline if secrets are detected. Never commit real credentials to version control.
...
> **Danger**: *Never commit credentials.yml to version control!* Always keep it in `.gitignore`.
