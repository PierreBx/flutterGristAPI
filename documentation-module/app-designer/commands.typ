...
#import "../common/styles.typ": command_table
...
#command_table((
  (
    ...
    description: "Check YAML file for syntax errors",
    example: "yamllint app_config.yaml"
  ),
  (
...
#command_table((
  (
    command: "Access Grist UI",
    description: "Open Grist web interface",
    example: "Open http://localhost:8484 or your Grist URL"
  ),
  (
...
#troubleshooting_table((
  (
    ...
    solution: "Check YAML syntax with validator. Verify all required fields are present.",
    priority: "high"
  ),
  (
