...
#import "../common/styles.typ": info_box

#info_box(type: "info")[
  *Test User Password Hash:* For testing, use this pre-hashed password for "password123":
...
#info_box(type: "warning")[
  *Security:* Never hardcode API keys in YAML files! Use environment variables:
...
#import "../common/styles.typ": troubleshooting_table

#troubleshooting_table((
  (
    issue: "App fails to load with 'Invalid YAML' error",
    solution: "Check YAML syntax - ensure proper indentation (use spaces, not tabs). Validate with an online YAML validator.",
    priority: "high"
  ),
  (
