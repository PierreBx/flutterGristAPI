...
#info_box(type: "warning")[
  *Critical:* Your YAML configuration must match your Grist schema. Column names, data types, and table references in your YAML must exactly match what exists in Grist, or the app will fail to load data.
]
